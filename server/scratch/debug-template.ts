...
await app.inject({ method:'POST', url:'/api/v1/auth/register', payload:{ username:'alice', email:'a@e.com', password:'correct horse battery staple 42' } })
await app.inject({ method:'POST', url:'/api/v1/auth/register', payload:{ username:'bob', email:'b@e.com', password:'correct horse battery staple 42' } })
